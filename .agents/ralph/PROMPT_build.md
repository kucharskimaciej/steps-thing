...
11. Append a progress entry to {{PROGRESS_PATH}} with run/commit/test details (format below), then commit that progress/log update too when No-commit is false.
